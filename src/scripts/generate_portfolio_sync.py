...
def render_faq_crosslinks(data: dict[str, Any]) -> str:
    ...
    return (
        ...
        f"Structured answer snippets (JSON): {repo['llmsIndexJson']}  \n"
...
def render_llms_snippet(data: dict[str, Any]) -> str:
    ...
    return (
        ...
        "Generated from `llms-index.json`. Append under `## Machine-readable indexes` "
        ...
        "Cross-linked machine-readable index for the GitHub profile README repo. "
        ...
        f"- Expanded agent context: {repo['llmsCtxFullTxt']}\n"
        ...
        f"- Tech stack ({stack['toolCount']} tools): {repo['stackMd']}\n"
